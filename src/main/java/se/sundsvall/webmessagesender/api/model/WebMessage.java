...
public class WebMessage {
	...
	@Override
	public int hashCode() { return Objects.hash(created, externalReferences, id, message, partyId); }
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(created, other.created) && Objects.equals(externalReferences, other.externalReferences) && Objects.equals(id, other.id)
			&& Objects.equals(message, other.message) && Objects.equals(partyId, other.partyId);
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("WebMessage [id=").append(id).append(", partyId=").append(partyId).append(", message=").append(message).append(", externalReferences=")
			.append(externalReferences).append(", created=").append(created).append("]");
