...
public class CreateWebMessageRequest {
	...
	@Override
	public int hashCode() { return Objects.hash(externalReferences, message, partyId); }
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(externalReferences, other.externalReferences) && Objects.equals(message, other.message) && Objects.equals(partyId, other.partyId);
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("CreateWebMessageRequest [partyId=").append(partyId).append(", message=").append(message).append(", externalReferences=").append(externalReferences)
			.append("]");
